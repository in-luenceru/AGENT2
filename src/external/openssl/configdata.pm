...
our %config = (
    ...
    "conf_files" => [
        "/build_wazuh/rpmbuild/BUILD/wazuh-agent-4.8.0/src/external/openssl/Configurations/00-base-templates.conf",
        "/build_wazuh/rpmbuild/BUILD/wazuh-agent-4.8.0/src/external/openssl/Configurations/10-main.conf"
    ],
    "cppflags" => [],
    "cxxflags" => [],
    "defines" => [
    ...
    "openssl_sys_defines" => [],
    "openssldir" => "",
    "options" => "enable-weak-ssl-ciphers no-acvp-tests no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-md2 no-msan no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-trace no-ubsan no-unit-test no-uplink no-zlib no-zlib-dynamic",
    "patch" => "12",
...
our %target = (
    ...
    "_conf_fname_int" => [
        ...
        "/build_wazuh/rpmbuild/BUILD/wazuh-agent-4.8.0/src/external/openssl/Configurations/10-main.conf",
        "/build_wazuh/rpmbuild/BUILD/wazuh-agent-4.8.0/src/external/openssl/Configurations/10-main.conf",
        "/build_wazuh/rpmbuild/BUILD/wazuh-agent-4.8.0/src/external/openssl/Configurations/shared-info.pl"
    ],
    "asm_arch" => "x86_64",
...
unless (caller) {
    ...
    use lib '/build_wazuh/rpmbuild/BUILD/wazuh-agent-4.8.0/src/external/openssl/util/perl';
    use OpenSSL::fallback '/build_wazuh/rpmbuild/BUILD/wazuh-agent-4.8.0/src/external/openssl/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/build_wazuh/rpmbuild/BUILD/wazuh-agent-4.8.0/src/external/openssl/Configurations';
        use gentemplate;
